...
| HTTP Status | Meaning |
|---:|---|
| `200` | Đã ghi nhận phản hồi |
| `409` | Chuyến đã được gán cho tài xế khác |
...
| HTTP Status | Meaning |
|---:|---|
| `200` | Trạng thái được cập nhật |
| `400` | Sai trình tự trạng thái |
...
|---:|---|
| `201` | Vị trí được lưu |
| `400` | Dữ liệu vị trí không hợp lệ |
